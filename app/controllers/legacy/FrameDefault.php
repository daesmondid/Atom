<?php
    ...
    class FrameDefault extends Controller {
        ...
        public function processDelete($model = '') {
            ...
            $modelManager->deleteObjectRow($model, $id);
            
            header('Location: '.$constant->baseUrl.'/'.$model);
            
        }
        
        public function docMain($model = '') {
            ...
            $this->model('Frame');
            $frame = new Frame($model, 'doc');
            $this->view('frame/index', ['constant' => $constant, 'frame' => $frame]);
            
            $this->view('doc/'.$model, ['constant' => $constant]);
